...
const vacancies = [
  ...
  {
    title: "Lecturer – Pharmacy",
    department: "School of Medicine, Health & Life Sciences",
    type: "Full-time",
    location: "KCU Main Campus - Bunga",
    deadline: "Deadline: 31-Jul-2026 5:00pm",
    summary: "Teach pharmaceutical sciences, support student assessment and contribute to curriculum delivery and research in pharmacy.",
    requirements: ["Master's or PhD in Pharmacy", "Teaching or professional pharmacy experience", "Commitment to student-centred learning"],
    pdfHref: "/careers/POSITION OF LECTURER – PHARMACY.pdf",
  },
  {
